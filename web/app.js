...
function botReply(text) {
  ...
  if (/(overthink|over-thinking|ruminat|can.t stop thinking|racing thoughts|thought loop|mind won.t switch off)/.test(lower)) return 'Overthinking can feel like your mind is trying to protect you by solving the same problem repeatedly. Try writing the worry in one sentence, separating what you can control from what you cannot, and choosing one tiny action for the first list. Then give your attention a 10-minute reset with breathing, grounding, or a simple physical task. If this happens often or affects sleep and daily life, a qualified professional can help.';
  if (/(panic attack|panic|anxious|anxiety|worried|nervous)/.test(lower)) return 'When anxiety rises, first make the next minute smaller: put both feet on the floor, breathe out slowly four times, and name five things you can see. Then write down what is in your control today. If panic keeps returning or disrupts your life, a qualified professional can help you build a treatment plan.';
  ...
  if (/(therap|counsel|psychologist|psychiatrist|mental health professional)/.test(lower)) return 'Therapy can offer a confidential place to understand patterns, build coping skills, and work toward goals. You can ask a prospective therapist about their training, approach, experience with your concern, cost, and confidentiality. It is okay to speak with more than one person before choosing.';
  if (/(medication|antidepress|prescription|side effect|pills)/.test(lower)) return 'Medication decisions are personal medical decisions. A licensed prescriber can explain possible benefits, side effects, interactions, and alternatives for your situation. Do not start, stop, or change a prescription without speaking with them; write down your questions and current medicines before an appointment.';
  if (/(ocd|intrusive thought|compulsion|obsession)/.test(lower)) return 'Unwanted thoughts do not define your character or intentions. Try not to argue with or punish yourself for having them; gently label the thought as a thought and return to the present task. Repetitive rituals or distressing intrusive thoughts deserve support from a clinician familiar with OCD and evidence-based treatment.';
  if (/(adhd|attention deficit|executive function|forgetful|can.t focus)/.test(lower)) return 'Attention difficulties can have many causes, so ClearMind cannot tell you whether you have ADHD. Helpful experiments include external reminders, visible task lists, body doubling, shorter work blocks, and reducing friction before starting. If this affects school, work, or relationships, consider a professional assessment.';
  if (/(eating disorder|binge|purge|restrict|body image|food guilt)/.test(lower)) return 'You deserve support without shame. Avoid compensating, extreme restriction, or judging your body as a measure of worth. A doctor and eating-disorder-informed therapist or dietitian can provide safe, individualized care. If you are fainting, medically unwell, or at immediate risk, seek urgent medical help.';
  if (/(alcohol|drinking|drug|substance|addict|quit smoking|withdrawal)/.test(lower)) return 'Changing substance use can be difficult, and support improves the odds of feeling better. Notice when and why you use, reduce access to triggers, and tell a trusted person what support you need. Some withdrawals can be dangerous, so speak with a medical professional before suddenly stopping heavy alcohol or sedative use.';
  if (/(bipolar|mania|manic|mood swing|mood swings)/.test(lower)) return 'Mood changes can have many explanations, and only a qualified clinician can assess them. Track sleep, energy, mood, and impulsive decisions without trying to diagnose yourself. If you have gone several nights with little sleep, feel unusually invincible, or feel out of control, contact a professional promptly and stay connected to someone you trust.';
  if (/(psychosis|hearing voices|seeing things|paranoid|reality)/.test(lower)) return 'That can feel frightening and deserves real-world support. Do not face it alone: contact a trusted person and a qualified mental-health professional promptly. If you may act on frightening beliefs, cannot stay safe, or feel at immediate risk, contact local emergency services. I cannot assess what is happening through chat.';
  if (/(diagnos|do i have|am i mentally ill|symptom)/.test(lower)) return 'A chat cannot diagnose you. Mental-health symptoms can overlap with stress, sleep problems, medical conditions, medication effects, and many other experiences. Write down what you notice, how long it has lasted, and how it affects daily life, then discuss it with a qualified professional.';
  if (/(help someone|support my|my friend|my partner is|someone i know)/.test(lower)) return 'Start by listening without rushing to fix it: “I am glad you told me. Do you want listening, ideas, or help finding support?” Ask directly about immediate safety if you are worried, stay connected, and encourage qualified help. You can care deeply while keeping your own boundaries.';
